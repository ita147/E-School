                ...
                <?php foreach ($results as $val) : ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <a onclick="deleteConfirm(' <?= base_url(); ?>master/kelas/delete_process/<?= encrypt_url($val['id']) ?>')" href="#!" class="btn btn-mini btn-danger">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            ...
                            <h4 id="myModalLabel" class="semi-bold">Edit Kelas.</h4>
                          </div>
                          <form action="<?= base_url('master/kelas/edit_process'); ?>" method="post">
...
<!-- load modal here -->
<?php $this->load->view('backend/master/kelas/modals'); ?>
