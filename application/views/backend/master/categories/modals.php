...
<div class="modal fade" id="newModal" tabindex="-1" role="dialog" aria-labelledby="newMenuModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form action="<?= base_url('master/categories/add_process'); ?>" method="post">
              ...
              <div class="row form-row">
                <div class="col-md-12">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="input1" placeholder="Kategori" name="name" style="width: 250px;" maxlength="20">
                    </div>
                  </div>
                </div>
              </div>
