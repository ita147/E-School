                ...
                <?php foreach ($results as $val) : ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <a onclick="deleteConfirm(' <?= base_url(); ?>master/categories/delete_process/<?= encrypt_url($val['id']) ?>')" href="#!" class="btn btn-mini btn-danger">
                  ...
                  <div class="modal fade" id="editModal<?php echo $val['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="newMenuModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <form action="<?= base_url('master/categories/edit_process'); ?>" method="post">
