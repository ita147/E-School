  ...
  <div class="col-md-12">
    <div class="grid simple ">
      ...
      <div class="grid-body no-border">
        ...
        <hr>
        <!-- start listing data here -->
        <form action="<?= base_url('duty/materi/add_process'); ?>" method="post">
         ...
         <!--      <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <select class="select2" name="is_publish" style="width: 100%" required="required">
                    ...
                    <option value="0" >Hanya Member</option>
                  </select>
                </div>
              </div> -->
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="fileField" placeholder="File" name="file" style="width: 100%" value="<?=set_value('file')?>" maxlength="128" required="required" readonly>
