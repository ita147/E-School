  ...
  <div class="col-md-12">
    <div class="grid simple ">
      ...
      <div class="grid-body no-border">
        ...
        <hr>
        <!-- start listing data here -->
        <form action="<?= base_url('duty/tugas/add_process'); ?>" method="post">
          <div class="row form-row">
            <div class="col-md-12 col-sm-12">
              <div class="form-group row">
                <label for="inputTitle" class="col-sm-2 col-md-2 col-form-label">Judul</label>
                <div class="col-sm-10 col-md-6">
                  <input type="text" class="form-control" id="inputTitle" placeholder="Title" name="title" style="width: 100%" value="<?=set_value('title')?>" maxlength="128" required="required">
                </div>
              </div>
              <div class="form-group row">
                <label for="input_description" class="col-sm-2 col-form-label">Deskripsi</label>
                <div class="col-sm-10">
                  <textarea name="description" class="form-control" style="width: 100%" rows="10" id="input_description" maxlength="256"><?=set_value('description')?></textarea>
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-8 col-md-6">
                  <div class="input-append success date col-md-10 col-lg-6 no-padding">
                    <input type="text" class="form-control datepicker" name="max_upload" value="<?=set_value('max_upload')?>" required="required">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="fileField" placeholder="File" name="file" style="width: 100%" value="<?=set_value('file')?>" maxlength="128" readonly>
