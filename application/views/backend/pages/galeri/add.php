  ...
  <div class="col-md-12">
    <div class="grid simple ">
      ...
      <div class="grid-body no-border">
        ...
        <form action="<?= base_url('pages/galeri/add_process'); ?>" method="post">
          <div class="row form-row">
            <div class="col-md-12">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <textarea name="description" class="form-control" style="width: 100%" rows="10" id="description" maxlength="200"><?=set_value('description')?></textarea>
                </div>
              </div>
