  ...
  <div class="col-md-12">
    <div class="grid simple ">
      ...
      <div class="grid-body no-border">
        ...
        <form action="<?= base_url('member/member/add_process'); ?>" method="post">
          <div class="row form-row">
            <div class="col-md-12">
              <div class="form-group row">
                <label for="inputName" class="col-sm-2 col-form-label">Nama Lengkap</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="inputName" placeholder="Nama" name="name" style="width: 100%" value="<?=set_value('name')?>" maxlength="128" required="required">
                </div>
              </div>
              <div class="form-group row">
                <label for="nisn" class="col-sm-2 col-form-label">NISN</label>
                <div class="col-sm-10">
                  <input type="number" class="form-control" id="nisn" placeholder="NISN" name="nisn" style="width: 100%" value="<?=set_value('nisn')?>" max-length="25" required="required">
                </div>
              </div>
              <div class="form-group row">
                <label for="tempat_lahir" class="col-sm-2 col-form-label">Tempat Lahir</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="tempat_lahir" placeholder="Tempat Lahir" name="tempat_lahir" style="width: 100%" value="<?=set_value('tempat_lahir')?>" max-length="50" required="required">
                </div>
              </div>
               <div class="form-group row">
                <label for="tanggal_lahir" class="col-sm-2 col-form-label">Tanggal Lahir</label>
                <div class="col-sm-10">
                  <input type="date" class="form-control" id="tanggal_lahir" placeholder="Tanggal Lahir" name="tanggal_lahir" style="width: 100%" value="<?=set_value('tanggal_lahir')?>" max-length="50" required="required">
                </div>
              </div>
              <div class="form-group row">
                <label for="inputAlamat" class="col-sm-2 col-form-label">Alamat</label>
                <div class="col-sm-10">
                  <textarea name="alamat" class="form-control" style="width: 100%" rows="10" id="inputAlamat" required="required"><?=set_value('alamat')?></textarea>
                </div>
              </div>
              <div class="form-group row">
                <label for="inputstudent_phone" class="col-sm-2 col-form-label">Nomor Telepon Siswa</label>
                <div class="col-sm-10">
                  <input type="student_phone" class="form-control" id="inputstudent_phone" placeholder="Nomor Telepon Siswa" name="student_phone" style="width: 100%" value="<?=set_value('student_phone')?>" maxlength="20" required="required">
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <select class="select2" name="status" style="width: 100%" required="">
                    <option value="1" <?php echo (set_value('status') == 1) ?  'selected="selected"' : '' ?>>Siswa Aktif</option>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="email" class="form-control" id="inputEmail" placeholder="Email" name="email" style="width: 100%" value="<?=set_value('email')?>"  maxlength="100">
                </div>
              </div>
              <div class="form-group row">
