  ...
  <div class="col-md-12">
    <div class="grid simple ">
      ...
      <div class="grid-body no-border">
        ...
        <form action="<?= base_url('homepage/galeri/edit_process'); ?>" method="post">
          ...
          <div class="row form-row">
            <div class="col-md-12">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <textarea name="description" class="form-control" style="width: 100%" rows="10" id="description"><?=set_value('description')?><?=$results['description']?></textarea>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="color" class="form-control" id="text_color" placeholder="Warna Text" name="text_color" style="width: 50%" value="<?=$results['text_color']?>" maxlength="10">
                </div>
              </div>
            </div>
          </div>
