  ...
  <div class="col-md-12">
    <div class="grid simple ">
      ...
      <div class="grid-body no-border">
        ...
        <form action="<?= base_url('pengajar/edit_process'); ?>" method="post">
          ...
          <div class="row form-row">
            <div class="col-md-12">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <textarea name="riwayat_pendidikan" class="form-control" style="width: 100%" rows="10" id="inputriwayat_pendidikan"><?=$pengajar['riwayat_pendidikan']?></textarea>
                </div>
              </div>
              <div class="form-group row">
                <label for="inputPhone" class="col-sm-2 col-form-label">Nomor Telepon</label>
                <div class="col-sm-10">
                  <input type="phone" class="form-control" id="form" placeholder="Nomor Telepon" name="phone" style="width: 100%" value="<?=$pengajar['phone']?>" maxlength="20" >
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <select class="select2" name="kelas_id[]" multiple style="width: 100%">
                    <?php foreach ($kelas as $val) : ?>
                      <option value="<?=$val['id']?>" <?php echo (in_array($val['id'], $pengajar['kelas_id'])) ?  'selected="selected"' : '' ?>><?=$val['name']?></option>
                    <?php endforeach; ?>
                  </select>
                </div>
              </div>
