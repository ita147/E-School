      ...
      <div class="grid-body no-border">
        ...
        <div class="pull-right">
          <a data-toggle="modal" data-target="#newModal" class="btn btn-success btn-mini" data-toggle="modal" >
            <i class="fa fa-plus"></i> Tambah Tags </a>
        </div>
        <br>
        <br>
            ...
            <tbody>
                <?php foreach ($results as $val) : ?>
                  <tr>
                    ...
                    <td><?=$val['slug']?></td>
                    <td>
                      <a data-target="#editModal<?php echo $val['id'] ?>" class="btn btn-warning btn-mini" data-toggle="modal">
                          <li class="fa fa-pencil"></li>
                      </a>
                      <a onclick="deleteConfirm(' <?= base_url(); ?>post/tags/delete_process/<?= encrypt_url($val['id']) ?>')" href="#!" class="btn btn-mini btn-danger">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            ...
                            <h4 id="myModalLabel" class="semi-bold">Edit Tags.</h4>
                          </div>
                          <form action="<?= base_url('post/tags/edit_process'); ?>" method="post">
...
<!-- load modal here -->
<?php $this->load->view('backend/post/tags/modals'); ?>
